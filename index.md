...
<section class="welcome-hero">
	...
	<div class="welcome-card">
		<h3>Focus Areas</h3>
		<p>API docs, release notes, SaaS guides, and doc-as-code workflows.</p>
		<div class="welcome-meta">
			<span>11+ years in technical writing</span>
			<span>DITA/XML, Markdown, and modern tooling</span>
			<span>AI-assisted documentation workflows</span>
		</div>
	</div>
</section>
...
<section>
	...
	<div class="welcome-grid">
		...
		<article class="welcome-tile">
			...
			<p>Start with the skills, tools, and steps that make the transition easier.</p>
		</article>
		<article class="welcome-tile">
